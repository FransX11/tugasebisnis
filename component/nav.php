...
<nav class="navbar navbar-fixed">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="home.php">
        <img style="width:14vw; height:7vh; padding-top:0px;" alt="Brand" src="asset/img/pointer.png">
      </a>
    </div>
  ...
  <div class="container" id="log">
    <ul class="nav nav-tabs nav-justified">
      <li><a href="#freg" data-toggle="tab" style="font-style:bold;font-size: 1.2em; color:#f53214">Daftar</a></li>
      <li class="active"><a href="#flogin" data-toggle="tab" style="font-style:bold;font-size: 1.2em; color:#f53214">Login</a></li>
    </ul>
...
<div class="container-fluid kategori">
  <div class="row">
    <div class="col-xs-2 col-xs-offset-2">
        <a href="home.php"><img style="width:14vw; height:7vh; padding-top:2vh;" alt="Brand" src="asset/img/pointer.png"></a>
    </div>
    <div class="col-xs-6">
      <ul class="nav nav-pills kategori2">
        ...
        <li><a href="?kategori=sarimbit">Sarimbit</a></li>
      </ul>
    </div>
  </div>
</div>
