<?php 
  ...
  if($query){
    echo '
      <script>
      alert("Terima Kasih sudah Berbelanja, Silahkan Tranfer ke Rekening BCA 2970-5786-10 an. Fransiscus Xaverius. Barang anda akan segera kami kirim setelah pembayaran dilakukan. Terima Kasih.!");
