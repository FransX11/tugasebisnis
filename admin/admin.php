          ...
          <div class="row">
            <div class="col-xs-11 col-offset-xs-1">
                ...
                <table class="table table-hover">
                  <thead>
                    <tr>
                      <th class="id-transaksi text-center" style="width:20vw">ID Transaksi</th>
                      <th class="id-user text-center" style="width:20vw">ID User</th>
                      <th class="daftar-barang text-center" style="width:20vw">Nama Barang</th>
                      <th class="id-transaksi text-center" style="width:20vw">Total</th>
                      <th class="alamat text-center" style="width:20vw">Alamat</th>
                      <th class="id-transaksi text-center" style="width:20vw">Tanggal</th>
                  ...
                  <?php 
                    ...
                    if($jumlah == 0){
                        ...
                        while($arrayBarang = mysqli_fetch_array($queryBarang)){
                          $queryUser = mysqli_query($conn, "SELECT * FROM tabel_transaksi LEFT JOIN tabel_user ON tabel_transaksi.idUser = tabel_user.idUser");
                           $arrayUser = mysqli_fetch_array($queryUser);
                          echo '
                            <tr>
                            <td class="id-transaksi text-center">'.$arrayBarang['idTransaksi'].'</td>
                            <td class="id-user text-center">'.$arrayUser['idUser'].'</td>
                            <td class="daftar-barang text-center" style="width:20vw">'.$arrayBarang['daftarBarang'].'</td>
                            <td class="id-transaksi text-center">Rp. '.$arrayBarang['total'].'</td>
                            <td class="alamat text-center"> '.$arrayUser['alamat'].'</td>
